...
class FavoritaFormatter(tft.data_formatters.base.GenericDataFormatter):
  ...
  _column_definition = [
      ...
      ('log_sales', DataTypes.REAL_VALUED, InputTypes.TARGET), # past 11
      ('onpromotion', DataTypes.CATEGORICAL, InputTypes.KNOWN_INPUT), # past 3
      ('transactions', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT), # past 1
      ('oil', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT), # past 2
      ('day_of_week', DataTypes.CATEGORICAL, InputTypes.KNOWN_INPUT), # past 4
      ('day_of_month', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT), # past 5
      ('month', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT), # past 6
      ('national_hol', DataTypes.CATEGORICAL, InputTypes.KNOWN_INPUT), # past 7
      ('regional_hol', DataTypes.CATEGORICAL, InputTypes.KNOWN_INPUT), # past 8
      ('local_hol', DataTypes.CATEGORICAL, InputTypes.KNOWN_INPUT), # past 9
      ('open', DataTypes.REAL_VALUED, InputTypes.KNOWN_INPUT), # past 10
