...
class TemporalFusionTransformer(object):
  ...
  def _build_base_graph(self):
    ...
    # print("Static inputs: ", static_inputs)
  ...
  def build_model(self):
    ...
    with tf.compat.v1.variable_scope(self.name):
      ...
      # model.compile(loss='mae', optimizer=adam, sample_weight_mode='temporal')
  ...
  def predict(self, df, return_targets=True):
  ...
  def get_attention(self, df):
    ...
    # print("data['identifier']: ",data['identifier']) just the car ids
    # print("Type of data: " , type(data)) dict
    inputs = data['inputs']
